...
breathe_projects = {
    'rmf_utils': '_build/doxygen/xml'
}
breathe_default_project = 'rmf_utils'

exhale_args = {
    'containmentFolder': './api',
    'rootFileName': 'rmf_utils_root.rst',
    'rootFileTitle': 'rmf_utils API',
    'doxygenStripFromPath': '../..',
    'createTreeView': True,
    'exhaleExecutesDoxygen': False,
    'exhaleDoxygenStdin': 'INPUT = ../rmf_utils/include',
}
